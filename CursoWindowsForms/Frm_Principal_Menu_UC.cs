    ...
    public partial class Frm_Principal_Menu_UC : Form
    {
        ...
        private void abrirImagemToolStripMenuItem_Click(object sender, EventArgs e)
        {
           OpenFileDialog Db = new OpenFileDialog();
            Db.InitialDirectory = "D:\\projetos\\windows-forms\\curso\\CursoWindowsForms\\CursoWindowsForms\\Imagens";
            Db.Filter = "PNG|*.PNG";
        ...
        private void conectarToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if(F.DialogResult == DialogResult.OK)
            {
                ...
                if(CursoWindowsFormsBiblioteca.Cls_Uteis.
                    validaSenhaLogin(senha) == true )
                {
        ...
        {
            Frm_Questao Db = new Frm_Questao("icons8_key_48",
